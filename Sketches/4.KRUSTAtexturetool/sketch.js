...
function createControlPanel() {
  ...
  createP('Select font').position(width + 40, 400).style('font-size','13px').style('font-family','sans-serif');
  selF = createSelect();
  selF.position(width + 40, 435);
  selF.option('Thin');
  selF.option('Regular');
  selF.option('Medium');
  selF.selected('Thin');
  ...
  lineCountSlider.position(width + 40, 315);
  lineCountSlider.style('width','100px');
  
  createP('Leading').position(width + 40, 340).style('font-size','13px').style('font-family','sans-serif');
  leadingSlider = createSlider(0,200,80);
  leadingSlider.position(width + 40, 370);
  ...
  yWaveSizeSlider.position(width + 210, 200);
  ...
  yWaveLengthSlider.position(width + 210, 255);
  ...
  yWaveOffsetSlider.position(width + 210, 315);
  yWaveOffsetSlider.style('width','100px');
  
  createP('Wave Speed').position(width + 210, 340).style('font-size','13px').style('font-family','sans-serif');
  yWaveSpeedSlider = createSlider(0, 0.25, 0.05, 0.01);
  yWaveSpeedSlider.position(width + 210, 370);
