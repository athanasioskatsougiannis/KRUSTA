...
function draw() {
  ...
  createP(tracking).position(1095, 540).style('background','white');
...
function createControlPanel() {
  ...
  createP('Wave Offset').position(width + 40, 580);
  yWaveOffsetSlider = createSlider(0, PI, 3, 0.01);
  yWaveOffsetSlider.position(width + 40, 620);
  yWaveOffsetSlider.style('width','100px');
   
  createP('Wave Speed').position(width + 40, 640);
  yWaveSpeedSlider = createSlider(0, 0.25, 0.01, 0.01);
  yWaveSpeedSlider.position(width + 40, 680);
  ...
  createP('Line Count').position(width + 210, 580);
  lineCountSlider = createSlider(0,50,8);
  lineCountSlider.position(width + 210, 620);
  lineCountSlider.style('width','100px');
  
  createP('Leading').position(width + 210, 640);
  leadingSlider = createSlider(0,200,70);
  leadingSlider.position(width + 210, 680);
