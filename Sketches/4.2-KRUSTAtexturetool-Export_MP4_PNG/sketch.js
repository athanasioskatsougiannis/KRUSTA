...
function createControlPanel() {
  ...
  createP('Tracking').position(width + 40, 170).style('font-size','13px').style('font-family','sans-serif');
  trackingSlider = createSlider(0,100,23,0.01);
  trackingSlider.position(width + 40, 205);
  trackingSlider.style('width','100px');

  createP('Line Count').position(width + 40, 230).style('font-size','13px').style('font-family','sans-serif');
  lineCountSlider = createSlider(0,50,8);
  lineCountSlider.position(width + 40, 265);
  lineCountSlider.style('width','100px');
  
  createP('Leading').position(width + 40, 290).style('font-size','13px').style('font-family','sans-serif');
  leadingSlider = createSlider(0,200,70);
  leadingSlider.position(width + 40, 320);
  ...
  yWaveSizeSlider.position(width + 210, 150);
  ...
  yWaveLengthSlider.position(width + 210, 205);
  ...
  yWaveOffsetSlider.position(width + 210, 265);
  ...
  yWaveSpeedSlider.position(width + 210, 320);
