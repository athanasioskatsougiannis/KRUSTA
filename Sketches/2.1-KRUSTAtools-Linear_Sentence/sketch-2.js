...
function createControlPanel() {
  ...
  checkboxSentence = createCheckbox('Sentence', true); checkboxSentence.position(width + 160, 175).style('padding','6px').style('border-radius','2px')
  checkboxSentence.changed(SentenceTXT);

  checkboxParagraph = createCheckbox('Paragraph', false); checkboxParagraph.position(width + 260, 175).style('padding','6px').style('border-radius','2px')
  checkboxParagraph.changed(ParagraphTXT);
